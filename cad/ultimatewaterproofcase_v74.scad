...
XAdditionalScrew          = t;  // can be true or false / Adds additional Screws on X axis (for large cases) --> Try it out
// Adds additional Screws on Y axis (for large cases) --> Try it out
YAdditionalScrew          = true ;  // can be true or false / Adds additional Screws on Y axis (for large cases) --> Try it out
...
DeviceHolder_X_Distance1  = 72;
// Distance between the holders in Y direction
DeviceHolder_y_Distance1  = 57;
...
// --- Halter für USB-Netzteilmodul (siehe cad/psu_holder_v1.scad) ---
ShowDeviceHolder3         = true;
// Hole in the cylinder for the screw // 2.9 Screw = 2mm hole
ScrewHoleDiameter3        = 2.6;
// The diamter of the screw cylinder
ScrewCylinderDiameter3    = 7;
// The height of the screw cylinders (also the deepness for the screw hole)
ScrewCylinderHeight3      = 4.0;
// Distance between the holders in X direction // == psu_holder_v1.scad screw_dx
DeviceHolder_X_Distance3  = 48;
// Distance between the holders in Y direction // == psu_holder_v1.scad screw_dy
DeviceHolder_y_Distance3  = 20;
// Move all holders 3 in X direction // Netzteil-Halter-Position (anpassen an dein Layout!)
Offset_X_3                = 5;
// Move all holders 3 in Y direction // Netzteil-Halter-Position (anpassen an dein Layout!)
Offset_Y_3                = 37;
